 ...
 */
Ext.define("bofpub.view.start.Controller", {
  extend: "portal.v1.public.start.Controller",
  alias: "controller.start",
  requires: ["bofpub.view.main.Main", "Ext.direct.Manager", "Ext.direct.PollingProvider"],
  ...
  startApplication: function () {
    ...
    this.mainPanel = Ext.create("bofpub.view.main.Main");
