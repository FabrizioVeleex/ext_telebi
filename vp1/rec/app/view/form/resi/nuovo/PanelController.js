...
Ext.define("recpub.view.form.resi.nuovo.PanelController", {
      ...
      dockedItems: [
        {
          ...
          items: [
            ...
            { xtype: "button", text: Locale.t("global.btn.annulla"), cls: "btnupper", ui: "acblue", handler: "onBtnAnnullaNewReso" },
            {
              xtype: "button",
      ...
      dockedItems: [
        {
          ...
          items: [
            { xtype: "component", flex: 0.5 },
            { xtype: "button", text: Locale.t("global.btn.annulla"), ui: "acred", cls: "btnAcRed btnupper", handler: "onBtnAnnullaNewReso" },
            {
              xtype: "button",
              ui: "acblue",
      ...
      condizioni3 = Ext.create("Ext.form.FieldSet", {
        ...
        items: [
          ...
          { xtype: "panel", cls: "inner2", html: '<span class="fontPT">' + recRecl["descrizione"] + "</span>" },
          {
            ...
            items: [
              { boxLabel: '<span class="fontPT">' + Locale.t("recpub.forms.resinew.step3check.radio1") + "</span>", name: "radio1", inputValue: 0 },
              { boxLabel: '<span class="fontPT">' + Locale.t("recpub.forms.resinew.step3check.radio2") + "</span>", name: "radio1", inputValue: 1 },
            ],
          },
        ],
      });
  ...
  onBtnNewResoStep3: function () {
    ...
    let recordtestata = this.getViewModel().get("record");
    Ext.Ajax.request({
      jsonData: {
       ...
       */
      url: Backend.REST_API + "forms/savenew/",
          ...
          if (resp["success"] === true) {
            Ext.create("Ext.Window", {
              ...
              html:
                ...
                Locale.t("recpub.forms.resinew.ottimo") +
                '</div><br><br><div class="">' +
                Locale.t("recpub.forms.resinew.textfinale") +
                "</div>",
              dockedItems: [
                {
                  xtype: "toolbar",
