...
Ext.define("recpub.view.form.resi.resi.PanelController", {
  ...
  requires: [
    ...
    'recpub.view.form.resi.resi.Radiostato'
  ],
  ...
  init: function () {
    this.panelNew = Ext.create("Ext.panel.Panel", {
      ...
      dockedItems: [
        {xtype: "toolbar", dock: "top", border: 2,
          style: {
            borderColor: "#bfbfbf", borderStyle: "solid", "border-width": "1px !important", "background-color": "#E4E5E4"
          },
          items: [
    ...
    this.panelOpen = Ext.create("recpub.view.form.resi.resi.GridOpen", {height: 450});
  },
  ...
  onChangeStato:function(rdg,newval) {
    let store=this.panelOpen.getStore()
    if (store) {
