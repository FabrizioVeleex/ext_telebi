 ...
 */
Ext.define('skd.view.grids.CellDragDrop', {
    extend: 'Ext.plugin.Abstract',
    alias: 'plugin.celldragdropgoma',
        ...
        if (me.enableDrag) {
            ...
            me.dragZone = new Ext.view.DragZone({
                ...
                getDragData: function (e) {
                    ...
                    /* ------------------------------------------------------------------------
                     * gestisco dd solo per le date e valori non vuoti
                     * gestisco abilitazione dd su prima od ultima cella o cella singola
                     */
                    header = view.getHeaderByCell(cell);
                    var value = record.data[header.dataIndex];
                    ...
                    if (value['sequenza']===2 || value['sequenza']===3){ //intermedia/fine
                        return false;
                    }
        ...
        if (me.enableDrop) {
            me.dropZone = new Ext.dd.DropZone(view.el, {
                ...
                onNodeEnter: function (target, dd, e, dragData) {
                    var self = this,
                        destType = target.record.data[target.columnName],
                        sourceType = dragData.record.data[target.columnName];
                    ...
                    //verifico se sono sulla stessa row e colonna differente
                    if (target.record.data['key']!==dragData.record.data['key']){
                        return;
                    }
                    //verifico se è un giorno festivo
                    if (destType['festivo']===true){
                        return;
                    }
                ...
                onNodeDrop: function (target, dd, e, dragData) {
                    ...
                    if (this.dropOK) {
                        this.view.fireEvent('dropDataCell',view,target,dragData);
