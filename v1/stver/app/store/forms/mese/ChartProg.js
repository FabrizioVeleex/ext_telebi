 ...
 */
Ext.define('stver.store.forms.mese.ChartProg', {
    extend: 'Ext.data.Store',
    alias:'store.v1-stver-chartmeseprog',

    requires: [
        'stver.model.forms.mese.ChartProg'
    ],
    ...
    generateData: function (chartStore) {
        ...
        for (let y = 1;y<chartStore.length+1;y++){
            ...
            if (oggi.getDay()!==6 && oggi.getDay()!==0) {
                let dataChart = Ext.create('stver.model.forms.mese.ChartProg',chartStore[y]);
