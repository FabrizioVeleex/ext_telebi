 ...
 */
Ext.define('amm.view.forms.scrivania.cards.Gridapps', {
    ...
    columns: [
        ...
        {text: Locale.t('amm.forms.scrivania.gridapps.titolo'), flex:1, dataIndex: 'titolo',sortable:false,
                ...
                return {
                    ...
                    listeners: {
                        beforequery: function (qe) {
                            ...
                            let storeapps=vm.get('storeComboapps')
                            if (storeapps) {
                                storeapps.getProxy().extraParams.idmodello=rec.data.id
                            }
                        },
                        select: function (combo, rec) {
                            ...
                            if (row) {
                                ...
                                if (lastrecord === row) {
                                    grid.getStore().add(Ext.create('amm.model.forms.scrivania.Gridapps', {
