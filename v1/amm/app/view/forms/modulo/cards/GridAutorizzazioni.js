 ...
 */
Ext.define('amm.view.forms.modulo.cards.GridAutorizzazioni', {
    ...
    columns: [
        {
            ...
            text: Locale.t('amm.forms.modulo.gridautorizzazioni.risorsa'),
        ...
        {
            text: Locale.t('amm.forms.modulo.gridautorizzazioni.ruolo'),
