 ...
 */
Ext.define('amm.view.forms.modulo.cards.GridRuoli', {
    ...
    columns: [//Non metto la funzione di cancellazione in quanto le funzioni sono normalmente assegnate,
        ...
        {text: Locale.t('amm.forms.modulo.gridruoli.ruolo'),
        ...
        {text: Locale.t('amm.forms.modulo.gridruoli.valore'),
        ...
        {text: Locale.t('amm.forms.modulo.gridruoli.descrizione'),
