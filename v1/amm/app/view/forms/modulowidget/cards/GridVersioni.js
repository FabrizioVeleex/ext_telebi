 ...
 */
Ext.define('amm.view.forms.modulowidget.cards.GridVersioni', {
    ...
    columns: [
        ...
        },
        {
            width: 100,
            xtype: 'checkcolumn',
            text: Locale.t('amm.forms.modulowidget.gridversion.attivo'),
            dataIndex: 'attivo',
            listeners: {
        ...
        {text: Locale.t('amm.forms.modulowidget.gridversion.versione'),
            width:100, menuDisabled: true, resizable: false, sortable: false,
            dataIndex: 'ver'
        },
        {text: Locale.t('amm.forms.modulowidget.gridversion.data'),
            width:120, menuDisabled: true, resizable: false, sortable: false,
            dataIndex: 'dataver',xtype: 'datecolumn', format: 'd/m/Y'
        },
        {text: Locale.t('amm.forms.modulowidget.gridversion.note'),
