 ...
 */
Ext.define('gpr.view.forms.funzione.Controller', {
    extend: 'portal.v1.view.forms.mainCard.Controller',
    alias: 'controller.v1-funzione',

    requires: [
        'gpr.model.forms.funzione.Model',
        'gpr.view.forms.funzione.cards.Funzione'
    ],
    ...
    init: function () {
        ...
        vm.set('record', Ext.create('gpr.model.forms.funzione.Model', {
    ...
    managerView: function () {
        ...
        this.cardFunzione = Ext.create('gpr.view.forms.funzione.cards.Funzione')
