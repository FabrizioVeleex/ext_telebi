 ...
 */
Ext.define('ana.view.forms.ufficio.cards.Ufficio', {
    ...
    items: [
        {xtype: 'container', flex: 1,
            ...
            items: [
                {xtype: 'textfield', fieldLabel: Locale.t('ana.forms.ufficio.fields.ufficio'),
        ...
        {xtype: 'container', flex: 1,
            ...
            items: [
                {xtype: 'textarea',scrollable:true,overflow:'auto',
                    fieldLabel: Locale.t('ana.forms.ufficio.fields.descrizione'),
