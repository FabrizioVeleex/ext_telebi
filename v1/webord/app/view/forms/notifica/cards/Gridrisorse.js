 ...
 */
Ext.define('webord.view.forms.notifica.cards.Gridrisorse', {
    ...
    columns: [
        ...
        {text: Locale.t('webord.forms.notifica.griddestinatari.risorsa'),
                ...
                return Ext.create('Ext.form.ComboBox', {
                    ...
                    listeners: {
                        select: function (combo,record) {
                            ...
                            if (lastrecord === row) {
                                grid.getStore().add(Ext.create('webord.model.forms.notifica.Gridrisorse', {
