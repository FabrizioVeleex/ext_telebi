 ...
 */
Ext.define("prd.forms.tipologia.controller.Controller", {
  extend: "portal.v1.view.forms.mainCard.Controller",
  mixins: ["portal.v1.global.Util"],
  alias: "controller.v1-prd-controller-tipologia",

  requires: [
    "Ext.window.Toast",
    "prd.forms.tipologia.Model",
    "prd.forms.tipologia.controller.ManagerBtn",
    "prd.forms.tipologia.controller.ManagerCards",
    'Ext.drag.Target',
  ...
  init: function () {
    ...
    vm.set(
      "record",
      Ext.create("prd.forms.tipologia.Model", {
  ...
  managerView: function () {
    ...
    let me = this,
      ...
      managerBtn = Ext.create("prd.forms.tipologia.controller.ManagerBtn"),
      managerCards = Ext.create("prd.forms.tipologia.controller.ManagerCards");

    try {
      // Titolo tab
      vm.set("title", record.data["num_doc"] + " - " + record.data["rag_soc"] || "n.d.");
      vm.set("label", Locale.t("prd.forms.tipologia.title"));
