 ...
 */
Ext.define("atp.global.gridMail.Grid", {
  ...
  columns: [
      ...
      items: [
        {
          getClass: function (v, metadata, r) {
            ...
            switch (r.data.status) {
              case 0:
                stato = Locale.t("atp.grids.attivita.columns.statusmail.attesa")
                css += "fa-clock bd-color-orange";
                break;
              case 1:
                stato = Locale.t("atp.grids.attivita.columns.statusmail.inviato")
                css += "fa-envelope bd-color-green";
                break;
              case 2:
                stato = Locale.t("atp.grids.attivita.columns.statusmail.letto")
                css += "fa-envelope-open-text bd-color-green";
                break;
              case 3:
                stato = Locale.t("atp.grids.attivita.columns.statusmail.scaricato")
                css += "fa-envelope-open-text bd-color-green";
                break;
              default:
                break;
      ...
      items: [
        {
          getClass: function (v, metadata, r) {
            ...
            if (r.data.attach && r.data.attach.length > 0) {
              metadata.tdAttr = 'data-qtip="' + Locale.t("atp.forms.attivita.cards.infodoc.gridmail.attach") + "<hr>" + r.data.attach.map(el => el.file).join('<br>') + '"';
    ...
    {
      text: Locale.t("atp.forms.attivita.cards.infodoc.gridmail.sendDate"),
      width: 170,
      menuDisabled: true,
      xtype: "datecolumn",
    ...
    {
      text: Locale.t("atp.forms.attivita.cards.infodoc.gridmail.from"),
      minWidth: 150,
      flex: 1,
      menuDisabled: true,
      renderer: function (v, metadata, r) {
    ...
    {
      text: Locale.t("atp.forms.attivita.cards.infodoc.gridmail.to"),
      minWidth: 150,
      flex: 1,
      menuDisabled: true,
      // dataIndex: 'infoMail',
