 ...
 */
Ext.define("atp.global.mail.Mail", {
  ...
  requires: [
    ...
    'Ext.panel.Panel',
    'atp.global.mail.tagAttach.Combo',
    'atp.global.mail.tagEmail.Combo',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              xtype: "textfield",
              fieldLabel: Locale.t("atp.forms.attivita.cards.fields.mittente"),
              flex: 1,
        ...
        },
        {
          ...
          items: [
            {
              fieldLabel: Locale.t("atp.forms.attivita.cards.mail.fields.mailto"),
              xtype: "v1-atp-forms-documento-tagmail",
              flex: 1,
              bind: {
                store: "{storeEmailNew}",
                value: "{record.mailto}",
        ...
        },
        {
          ...
          items: [
            {
              fieldLabel: Locale.t("atp.forms.attivita.cards.fields.attach.label"),
        ...
        },
        {
          ...
          items: [
            {
              xtype: "htmleditor",
              fieldLabel: Locale.t("atp.forms.attivita.cards.mail.fields.corpo"),
              flex: 1,
              autoScroll: true,
