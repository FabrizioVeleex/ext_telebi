 ...
 */
Ext.define('impexp.view.forms.modulo.cards.Gridautorizza', {
    ...
    columns: [
        ...
        {text: Locale.t('impexp.forms.modulo.autorizzazioni.columns.iduser'),
                ...
                return Ext.create('Ext.form.ComboBox', {
                    ...
                    listeners: {
                        select: function (combo,record) {
                            ...
                            if (lastrecord === row) {
                                grid.getStore().add(Ext.create('impexp.model.forms.modulo.Gridrisorse', {
