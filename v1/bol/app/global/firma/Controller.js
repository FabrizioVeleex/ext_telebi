 ...
 */
Ext.define("bol.global.firma.Controller", {
  ...
  onAfterRender: function () {
    ...
    if (noSpool.length > 0) {
      vm.set("htmlNoSpool", `<span style="font-size:19px;">` + Locale.t("bol.grids.documenti.winfirma.docselected") + `: ${nRecordGood} </br><span style="color:red;"><hr>` + Locale.t("bol.grids.documenti.winfirma.warning") + `! ${noSpool.length} ` + Locale.t("bol.grids.documenti.winfirma.warningdesc") + `</span></span>`);
  ...
  onStampa: function () {
    if (this.signaturePad.isEmpty()) {
      Ext.Msg.show({
        ...
        msg: Locale.t("bol.grids.documenti.winfirma.firmavuota"),
        icon: Ext.MessageBox.INFO,
        buttonText: {
          no: Locale.t("bol.grids.documenti.winfirma.firmavuotabtn"),
        },
      });
    } else {
