 ...
 */
Ext.define("bol.global.firma.Btn", {
  extend: "Ext.button.Button",
  xtype: "bol-global-btn-firma",
  requires: [
    "bol.global.firma.Windows"
  ],
  tooltip: Locale.t("bol.grids.documenti.btn.firma.tooltip"),
  text: Locale.t("bol.grids.documenti.btn.firma.text"),
  ui: "blue",
  ...
  handler: function () {
    ...
    if (records.length === 0) {
      Ext.Msg.show({
        ...
        msg: Locale.t("bol.grids.documenti.winfirma.erroreselect"),
        buttons: Ext.Msg.OK,
    ...
    let win = Ext.create("bol.global.firma.Windows", {
