 ...
 */
Ext.define("bol.global.stampa.Controller", {
  extend: "Ext.app.ViewController",
  alias: "controller.bol-v1-global-stampa",
  ...
  onAfterRender: function () {
    ...
    if (noSpool.length > 0) {
      vm.set("htmlNoSpool", `<span style="font-size:19px;">` + Locale.t("bol.grids.documenti.htmlnospool.docsselected") + ` : ${nRecordGood} </br><span style="color:red;"><hr>` + Locale.t("bol.grids.documenti.htmlnospool.warning") + `! ${noSpool.length} ` + Locale.t("bol.grids.documenti.htmlnospool.attesa") + `</span></span>`);
    }
  },
  onStampa: function () {
    let me = this,
    ...
    Ext.Ajax.request({
      scope: this,
      url: Backend.REST_API + "global/stampa/",
      method: "PUT",
