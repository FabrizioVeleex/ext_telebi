Ext.define("bol.global.stampa.Btn", {
  extend: "Ext.button.Button",
  xtype: "bol-global-btn-stampa",
  require: [
    "bol.global.stampa.Windows"
  ],
  tooltip: Locale.t("bol.grids.documenti.btn.print.tooltip"),
  text: Locale.t("bol.grids.documenti.btn.print.text"),
  ui: "orange",
  ...
  handler: function () {
    ...
    let win = Ext.create("bol.global.stampa.Windows", {
    ...
    function onClosePrintOk(records) {
      ...
      if (fileNotFound.length > 0) {
        ...
        testoEccezione =
          ...
          "<hr>" +
          Locale.t("bol.grids.documenti.winprint.listeccezione");
        hidden = false;
        ui = "red";
        titleEccezione =
          " [" +
          Locale.t("global.attenzione") +
          " " +
          Locale.t("bol.grids.documenti.winprint.listtitleeccezione") +
          "]";
      }
      let wincomplete = Ext.create("Ext.window.Window", {
        ...
        modal: true,
        title:
          Locale.t("bol.grids.documenti.winprint.printcomplete") +
          titleEccezione,
        dockedItems: [
          {
            xtype: "toolbar",
            ...
            items: [
              {
                ...
                html:
                  "<h2>" +
                  Locale.t("bol.grids.documenti.winprint.printlist") +
                  "</h2>",
              },
              {
                xtype: "griddocumenti",
