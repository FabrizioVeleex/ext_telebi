Ext.define("bol.global.invia.Btn", {
  extend: "Ext.button.Button",
  xtype: "bol-global-btn-invia",
  require: [
    "bol.global.invia.Windows",
    "bol.global.component.griddocumenti.GridDocumentiInvia",
    "bol.global.component.griddocumenti.GridDocumentiInviaError",
    "bol.global.component.griddocumenti.StoreDocumenti"
  ],
  azione: "I",
  desc: Locale.t("bol.grids.documenti.btn.esegui.invia"),
  text: Locale.t("bol.grids.documenti.btn.invia.text"),
  tooltip: Locale.t("bol.grids.documenti.btn.invia.tooltip"),
  ui: "orange",
  ...
  handler: function () {
    ...
    if (recordsGood.length === 0) {
      Ext.Msg.show({
        ...
        msg: Locale.t("bol.grids.documenti.winprint.erroreselect"),
        buttons: Ext.Msg.OK,
    ...
    let win = Ext.create("bol.global.invia.Windows", {
    ...
    function onCloseSend(records) {
      ...
      if (fileNotFound.length > 0) {
        ...
        testoEccezione =
          ...
          "<hr>" +
          Locale.t("bol.grids.documenti.winfirma.firmalisteccezione");
        hidden = false;
        ui = "red";
        titleEccezione =
          " [" +
          Locale.t("global.attenzione") +
          " " +
          Locale.t("bol.grids.documenti.winfirma.firmatitleeccezione") +
          "]";
      }
      let wincomplete = Ext.create("Ext.window.Window", {
        ...
        modal: true,
        title:
          Locale.t("bol.grids.documenti.winfirma.firmacomplete") +
          titleEccezione,
        dockedItems: [
          {
            xtype: "toolbar",
            ...
            items: [
              {
                ...
                html:
                  "<h2>" +
                  Locale.t("bol.grids.documenti.winfirma.firmalist") +
                  "</h2>",
              },
              {
