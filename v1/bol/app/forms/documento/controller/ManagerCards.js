Ext.define("bol.forms.documento.controller.ManagerCards", {
  requires: [
    'Ext.form.Panel',
    'bol.forms.documento.cards.Info',
    'bol.forms.documento.cards.NewMail',
    'bol.forms.documento.cards.Dashboard'
  ],
    ...
    me.listForms = [
      {
        ...
        card: Ext.create("bol.forms.documento.cards.Dashboard"),
        text: Locale.t("bol.forms.documento.cards.dashboard.title"),
        btn: {
          text: Locale.t("bol.forms.documento.cards.dashboard.title"),
      ...
      },
      {
        posizione: "info",
        backgroundColor: "LightBlue",
        card: Ext.create("bol.forms.documento.cards.Info"),
        text: Locale.t("bol.forms.documento.cards.infodoc.title"),
        btn: {
          text: Locale.t("bol.forms.documento.cards.infodoc.title"),
      ...
      },
      {
        ...
        text: Locale.t("bol.forms.documento.cards.anteprima.title"),
        btn: {
          text: Locale.t("bol.forms.documento.cards.anteprima.title"),
      ...
      },
      {
        ...
        text: Locale.t("bol.forms.documento.cards.anteprimafirma.title"),
        btn: {
          text: Locale.t("bol.forms.documento.cards.anteprimafirma.title"),
      ...
      },
      {
        posizione: "newmail",
        backgroundColor: "",
        card: Ext.create("bol.forms.documento.cards.NewMail", {
          posizione: "newmail",
        }),
        text: Locale.t("bol.forms.documento.cards.newmail.title"),
        btn: {
          text: Locale.t("bol.forms.documento.cards.newmail.title"),
