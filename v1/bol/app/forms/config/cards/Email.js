...
Ext.define('bol.view.forms.config.cards.Email', {
  ...
  requires: [
    ...
    'Ext.panel.Panel',
    'bol.view.forms.config.cards.email.TreePanel'
  ],
  scrollable: 'y',
  items: [
    {
    ...
    },
    {
      ...
      items: [
        {
          xtype: 'textfield', fieldLabel: Locale.t('bol.forms.config.fields.replyto'),
          flex: 1, allowBlank: false, blankText: Locale.t('global.form.blanktext'),
    ...
    },
    {
      ...
      items: [
        {
          xtype: 'textfield', fieldLabel: Locale.t('bol.forms.config.fields.email'),
          flex: 1, allowBlank: false, blankText: Locale.t('global.form.blanktext'),
          maxLength: 250, maxLengthText: Locale.t('global.form.maxlengthtext'),
