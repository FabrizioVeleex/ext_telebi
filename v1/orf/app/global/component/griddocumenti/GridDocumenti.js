 ...
 */
Ext.define("orf.global.component.griddocumenti.GridDocumenti", {
  ...
  columns: [
      ...
      items: [
        {
          getClass: function (view, metadata, record) {
            if (record.get('spool') === 0) {
              metadata.tdAttr = `data-qtip="${Locale.t('orf.grids.documenti.winfirma.nospool')}"`;
    ...
    {
      text: Locale.t("orf.grids.documenti.columns.cd_sogg_fat"),
    ...
    {
      text: Locale.t("orf.grids.documenti.columns.descr_trasp"),
