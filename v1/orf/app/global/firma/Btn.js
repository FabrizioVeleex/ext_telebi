 ...
 */
Ext.define("orf.global.firma.Btn", {
  extend: "Ext.button.Button",
  xtype: "orf-global-btn-firma",
  requires: [
    "orf.global.firma.Windows"
  ],
  tooltip: Locale.t("orf.grids.documenti.btn.firma.tooltip"),
  text: Locale.t("orf.grids.documenti.btn.firma.text"),
  ui: "blue",
  ...
  handler: function () {
    ...
    if (records.length === 0) {
      Ext.Msg.show({
        ...
        msg: Locale.t("orf.grids.documenti.winfirma.erroreselect"),
        buttons: Ext.Msg.OK,
    ...
    let win = Ext.create("orf.global.firma.Windows", {
