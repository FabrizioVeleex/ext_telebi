 ...
 */
Ext.define("orf.global.errorwindow.Controller", {
  extend: "Ext.app.ViewController",
  alias: "controller.orf-v1-global-errorwindow",
  ...
  //         vm.set("htmlNumeroDest", "<div style='font-size:18px;color:green'>" + Locale.t("orf.forms.documento.sendmail.nDest.yes") + ": " + rest.totalCount + "</div>")
  //       else
  //         vm.set("htmlNumeroDest", "<div style='font-size:18px;color:red'>" + Locale.t("orf.forms.documento.sendmail.nDest.no") + "</div>")
  ...
  //   if (noSpool.length > 0) {
  //     let result = Locale.t("orf.forms.documento.sendmail.documentsselected") + ":" + (nRecordGood - noSpool.length) + '/' + nRecordGood;
  //     if (noSpool.length > 0) {
  //       vm.set("htmlNoSpool", `<span style="font-size:19px;">${result} </br><span style="color:red;"><hr>${Locale.t("orf.forms.documento.sendmail.result")}</span></span>`);
  //     } else {
  ...
  //       me.view.el.unmask();
  //       // let rest = Ext.decode(res.responseText);
  //       // TODO competare risposta invio email
  //       Ext.Msg.show({
