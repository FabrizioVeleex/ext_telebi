Ext.define("orf.forms.documento.controller.ManagerCards", {
  requires: [
    'Ext.form.Panel',
    'orf.forms.documento.cards.Info',
    'orf.forms.documento.cards.NewMail',
    'orf.forms.documento.cards.Dashboard'
  ],
    ...
    me.listForms = [
      {
        ...
        card: Ext.create("orf.forms.documento.cards.Dashboard"),
        text: Locale.t("orf.forms.documento.cards.dashboard.title"),
        btn: {
          text: Locale.t("orf.forms.documento.cards.dashboard.title"),
      ...
      },
      {
        posizione: "info",
        backgroundColor: "LightBlue",
        card: Ext.create("orf.forms.documento.cards.Info"),
      ...
      },
      {
        ...
        text: Locale.t("orf.forms.documento.anteprima"),
        btn: {
          text: Locale.t("orf.forms.documento.anteprima"),
      ...
      },
      {
        ...
        text: Locale.t("orf.forms.documento.anteprimafirma"),
        btn: {
          text: Locale.t("orf.forms.documento.anteprimafirma"),
      ...
      },
      {
        posizione: "newmail",
        backgroundColor: "",
        card: Ext.create("orf.forms.documento.cards.NewMail", {
          posizione: "newmail",
        }),
        text: Locale.t("orf.forms.documento.newmail"),
        btn: {
          text: Locale.t("orf.forms.documento.newmail"),
