 ...
 */
Ext.define("orf.forms.documento.cards.NewMail", {
  ...
  requires: [
    ...
    'Ext.panel.Panel',
    'orf.forms.documento.component.tagAttach.Combo',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              xtype: "textfield",
              fieldLabel: Locale.t("orf.forms.documento.fields.subject.label"),
              emptyText: Locale.t("orf.forms.documento.fields.subject.placeholder"),
              flex: 1,
        ...
        },
        {
          ...
          items: [
            {
              xtype: "textfield",
              fieldLabel: Locale.t("orf.forms.documento.fields.mittente.label"),
              emptyText: Locale.t("orf.forms.documento.fields.mittente.placeholder"),
              flex: 1,
        ...
        },
        {
          ...
          items: [
            {
              fieldLabel: Locale.t("orf.forms.documento.fields.mailto.label"),
        ...
        },
        {
          ...
          items: [
            {
              xtype: "textfield",
              fieldLabel: Locale.t("orf.forms.documento.fields.replyto.label"),
              emptyText: Locale.t("orf.forms.documento.fields.replyto.placeholder"),
              flex: 1,
        ...
        },
        {
          ...
          items: [
            {
              fieldLabel: Locale.t("orf.forms.documento.fields.attach.label"),
