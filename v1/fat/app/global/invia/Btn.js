Ext.define("fat.global.invia.Btn", {
  extend: "Ext.button.Button",
  xtype: "fat-global-btn-invia",
  require: [
    "fat.global.invia.Windows",
    "fat.global.component.griddocumenti.GridDocumentiInvia",
    "fat.global.component.griddocumenti.GridDocumentiInviaError",
    "fat.global.component.griddocumenti.StoreDocumenti"
  ],
  azione: "I",
  desc: Locale.t("fat.grids.documenti.btn.esegui.invia"),
  text: Locale.t("fat.grids.documenti.btn.invia.text"),
  tooltip: Locale.t("fat.grids.documenti.btn.invia.tooltip"),
  ui: "orange",
  ...
  handler: function () {
    ...
    if (recordsGood.length === 0) {
      Ext.Msg.show({
        ...
        msg: Locale.t("fat.grids.documenti.winprint.erroreselect"),
        buttons: Ext.Msg.OK,
    ...
    let win = Ext.create("fat.global.invia.Windows", {
    ...
    function onCloseSend(records) {
      ...
      if (fileNotFound.length > 0) {
        ...
        testoEccezione =
          ...
          "<hr>" +
          Locale.t("fat.grids.documenti.winfirma.firmalisteccezione");
        hidden = false;
        ui = "red";
        titleEccezione =
          " [" +
          Locale.t("global.attenzione") +
          " " +
          Locale.t("fat.grids.documenti.winfirma.firmatitleeccezione") +
          "]";
      }
      let wincomplete = Ext.create("Ext.window.Window", {
        ...
        modal: true,
        title:
          Locale.t("fat.grids.documenti.winfirma.firmacomplete") +
          titleEccezione,
        dockedItems: [
          {
            xtype: "toolbar",
            ...
            items: [
              {
                ...
                html:
                  "<h2>" +
                  Locale.t("fat.grids.documenti.winfirma.firmalist") +
                  "</h2>",
              },
              {
