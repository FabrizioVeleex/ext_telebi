 ...
 */
Ext.define("fat.global.component.griddocumenti.GridDocumentiInviaError", {
  ...
  columns: [
    ...
    {
      text: Locale.t('fat.forms.documento.sendmail.columns.totmail'),
      dataIndex: "totemail",
      width: 90,
    ...
    {
      text: Locale.t('fat.forms.documento.sendmail.columns.data_doc'),
      dataIndex: "data_doc",
      width: 120,
      xtype: "datecolumn",
      format: "d/m/Y",
    ...
    {
      text: Locale.t('fat.forms.documento.sendmail.columns.cd_ord'),
      dataIndex: "num_doc",
      width: 90,
      filter: { type: "string" },
    },
    {
      text: Locale.t('fat.forms.documento.sendmail.columns.cd_sogg_fat'),
      dataIndex: "cd_sogg_fat",
      width: 80,
      filter: { type: "string" },
    },
    {
      text: Locale.t('fat.forms.documento.sendmail.columns.errormsg'),
      dataIndex: "errormsg",
      flex: 1,
      minWidth: 100,
      filter: { type: "string" },
