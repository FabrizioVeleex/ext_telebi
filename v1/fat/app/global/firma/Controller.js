 ...
 */
Ext.define("fat.global.firma.Controller", {
  ...
  onStampa: function () {
    if (this.signaturePad.isEmpty()) {
      Ext.Msg.show({
        ...
        msg: Locale.t("fat.grids.documenti.winfirma.firmavuota"),
        icon: Ext.MessageBox.INFO,
        buttonText: {
          no: Locale.t("fat.grids.documenti.winfirma.firmavuotabtn"),
        },
      });
    } else {
      ...
      Ext.Ajax.request({
        ...
        failure: function (res) {
          ...
          Ext.Msg.show({
            ...
            icon: Ext.MessageBox.INFO,
            buttonText: {
              no: Locale.t("fat.grids.documenti.winprint.firmaok"),
            },
          });
        },
      });
