Ext.define("fat.global.stampa.Btn", {
  extend: "Ext.button.Button",
  xtype: "spl-global-btn-stampa",
  require: [
    "fat.global.stampa.Windows"
  ],
  tooltip: Locale.t("fat.grids.documenti.btn.print.tooltip"),
  text: Locale.t("fat.grids.documenti.btn.print.text"),
  ui: "orange",
  ...
  handler: function () {
    ...
    let win = Ext.create("fat.global.stampa.Windows", {
