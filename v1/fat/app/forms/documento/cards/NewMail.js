 ...
 */
Ext.define("fat.forms.documento.cards.NewMail", {
  ...
  requires: [
    ...
    'Ext.panel.Panel',
    'fat.forms.documento.component.tagAttach.Combo',
    'fat.forms.documento.component.tagEmail.Combo'
  ],
  scrollable: "y",
  bodyPadding: 15,
  buttons: [
      ...
      items: [
        {
          ...
          flex: 1,
          bind: {
            html: Locale.t("fat.forms.documento.cards.newmail.title"),
          },
        },
        {
          xtype: "container",
        ...
        },
        {
          ...
          items: [
            {
              xtype: "textfield",
              fieldLabel: Locale.t("fat.forms.documento.fields.mailfrom"),
              flex: 1,
          ...
          items: [
            {
              ...
              xtype: "v1-fat-forms-documnto-tagmail",
              flex: 1,
              bind: {
                store: "{storeEmailNew}",
                value: "{record.mailto}",
        ...
        },
        {
          ...
          items: [
            {
              fieldLabel: Locale.t("fat.forms.documento.fields.attach.label"),
        ...
        },
        {
          ...
          items: [
            {
              xtype: "htmleditor",
              fieldLabel: Locale.t("fat.forms.documento.fields.corpo"),
              flex: 1,
              autoScroll: true,
