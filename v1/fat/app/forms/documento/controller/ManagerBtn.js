Ext.define("fat.forms.documento.controller.ManagerBtn", {
  requires: [
    'Ext.toolbar.Fill'
  ],
  insertBtn: function (me, record) {
    ...
    if (me.checkRuoli(["99", "10"])) {
      ...
      me.toolBar.add({
        ui: 'red',
        text: Locale.t('fat.forms.documento.btn.scarta.text'),
        tooltip: Locale.t('fat.forms.documento.btn.scarta.tooltip'),
    ...
    me.toolBar.add({
      ui: 'blue',
      text: Locale.t('fat.forms.documento.btn.excel.text'),
      tooltip: Locale.t('fat.forms.documento.btn.excel.tooltip'),
