 ...
 */
let SpcUser = [];
Ext.define('ord.main.Controller', {
    extend: 'portal.v1.view.main.ViewController',
    alias: 'controller.main',
    requires: [
        'ord.grids.ord.Grid',
        'ord.main.west.Ord',
        'ord.main.west.Telebi'
    ],
    onAfterRender: function () {
        //costruisco array viste
        if (Ext.global.Vars.infoCli.cli === 'telebi') {
            this.panels = {
                grid: Ext.create("ord.grids.ord.Grid"),
                panel: Ext.create("ord.main.west.Telebi"),
            }
        } else {
            this.panels = {
                grid: Ext.create("ord.grids.ord.Grid"),
                panel: Ext.create("ord.main.west.Ord"),
            }
        }
