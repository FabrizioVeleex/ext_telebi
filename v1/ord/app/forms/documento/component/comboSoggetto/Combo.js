 ...
 */
Ext.define('ord.forms.documento.component.comboSoggetto.Combo', {
  ...
  name: 'idsoggetto',
  itemId: 'comboSogg',
  fieldLabel: Locale.t('ord.forms.documento.btn.associa.soggetto'),
  labelWidth: 80,
  emptyText: Locale.t('ord.forms.documento.btn.associa.emptytext'),
  displayField: 'ragsoc',
  valueField: 'id',
  hideTrigger: true,
  width: 500,
