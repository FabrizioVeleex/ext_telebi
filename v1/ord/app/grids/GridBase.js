 ...
 */
Ext.define("ord.grids.GridBase", {
  extend: "portal.v1.view.grids.DefaultController",
  mixins: ["portal.v1.global.Util"],
  requires: [
    "Ext.container.Container",
    "ord.forms.documento.Panel",
  ...
  createForm: function (view, record, isnew) {
    ...
    this.getView().fireEvent(
      "createTab",
      Ext.create("ord.forms.documento.Panel", {
  ...
  onCloseFirmaOk: function (records) {
    ...
    let wincomplete = Ext.create("Ext.window.Window", {
      ...
      modal: true,
      title:
        Locale.t("ord.grids.documenti.winfirma.firmacomplete") + titleEccezione,
      dockedItems: [
        {
          xtype: "toolbar",
          layout: {
