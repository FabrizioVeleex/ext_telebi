 ...
 */
Ext.define("ord.global.component.griddocumenti.GridDocumentiInvia", {
  ...
  columns: [
      ...
      items: [
        {
          getClass: function (view, metadata, record) {
            if (record.get('spool') === 0) {
              metadata.tdAttr = `data-qtip="${Locale.t('ord.forms.documento.sendmail.columns.spool.no')}"`;
              return 'x-fas fa-times bd-action-null bd-color-red';
            }
            metadata.tdAttr = `data-qtip="${Locale.t('ord.forms.documento.sendmail.columns.spool.yes')}"`;
    ...
    {
      text: Locale.t('ord.forms.documento.sendmail.columns.totmail'),
      dataIndex: "totemail",
      width: 90,
    ...
    {
      text: Locale.t('ord.forms.documento.sendmail.columns.data_doc'),
      dataIndex: "data_doc",
      width: 120,
      xtype: "datecolumn",
      format: "d/m/Y",
    ...
    {
      text: Locale.t('ord.forms.documento.sendmail.columns.cd_ord'),
      dataIndex: "num_doc",
      width: 90,
      filter: { type: "string" },
    },
    {
      text: Locale.t('ord.forms.documento.sendmail.columns.cd_sogg_fat'),
      dataIndex: "cd_sogg_fat",
      width: 80,
      filter: { type: "string" },
    },
    {
      text: Locale.t('ord.forms.documento.sendmail.columns.rag_soc'),
      dataIndex: "rag_soc",
      flex: 1,
      minWidth: 100,
      filter: { type: "string" },
