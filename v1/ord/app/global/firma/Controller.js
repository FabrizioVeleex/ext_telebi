 ...
 */
Ext.define("ord.global.firma.Controller", {
  ...
  onStampa: function () {
    if (this.signaturePad.isEmpty()) {
      Ext.Msg.show({
        ...
        msg: Locale.t("ord.grids.documenti.winfirma.firmavuota"),
        icon: Ext.MessageBox.INFO,
        buttonText: {
          no: Locale.t("ord.grids.documenti.winfirma.firmavuotabtn"),
        },
      });
    } else {
      ...
      Ext.Ajax.request({
        ...
        failure: function (res) {
          ...
          Ext.Msg.show({
            ...
            icon: Ext.MessageBox.INFO,
            buttonText: {
              no: Locale.t("ord.grids.documenti.winprint.firmaok"),
            },
          });
        },
      });
