Ext.define("ord.global.stampa.Btn", {
  extend: "Ext.button.Button",
  xtype: "ord-global-btn-stampa",
  require: [
    "ord.global.stampa.Windows"
  ],
  tooltip: Locale.t("ord.grids.documenti.btn.print.tooltip"),
  text: Locale.t("ord.grids.documenti.btn.print.text"),
  ui: "orange",
  ...
  handler: function () {
    ...
    if (recordsGood.length === 0) {
      Ext.Msg.show({
        ...
        msg: Locale.t("ord.grids.documenti.winprint.erroreselect"),
        buttons: Ext.Msg.OK,
    ...
    let win = Ext.create("ord.global.stampa.Windows", {
    ...
    function onClosePrintOk(records) {
      let fileNotFound = records["fileNotFound"],
        ...
        storeDocumentiGood = Ext.create(
          "ord.view.global.firma.store.GridDocumenti"
        ),
