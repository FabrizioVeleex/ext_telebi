 ...
 */
Ext.define('snp.view.forms.notifica.cards.Notifica', {
    ...
    items: [
        {
            ...
            items: [
                {xtype: 'textfield', fieldLabel: Locale.t('snp.forms.notifica.fields.codice'),
                ...
                {xtype: 'textfield', fieldLabel: Locale.t('snp.forms.notifica.fields.nome'),
        ...
        {xtype: 'container', flex: 1, layout: { type: "hbox" },
            ...
            items: [
                {
                    xtype: 'textarea', scrollable: true, overflow: 'auto', fieldLabel: Locale.t('snp.forms.notifica.fields.descrizione'),
