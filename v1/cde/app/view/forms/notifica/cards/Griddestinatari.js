 ...
 */
Ext.define('cde.view.forms.notifica.cards.Griddestinatari', {
    ...
    columns: [
        ...
        {text: Locale.t('cde.forms.notifica.griddestinatari.risorsa'),
                ...
                return Ext.create('Ext.form.ComboBox', {
                    ...
                    listeners: {
                        select: function (combo,record) {
                            ...
                            if (lastrecord === row) {
                                grid.getStore().add(Ext.create('cde.view.forms.notifica.component.Gridrisorse', {
