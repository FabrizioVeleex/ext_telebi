  ...
  initFiltri: function () {
    try {
      ...
      this.filtriPanel = {
        ...
        filtri: {
          data_doc: {
            fs: Ext.create("portal.v1.view.filtri.datarange.Fieldset", { myTag: "ord", myName: "data_doc", title: Locale.t('spl.grids.documenti.column.data_doc') }),
          },
          combo_ord: {
            fs: Ext.create("spl.global.filtri.combo_ord.Fieldset")
          }
        }
      }
      ...
      this.filtriPanel.panel.add(
        ...
        this.filtriPanel.filtri.combo_ord.fs,
      )
