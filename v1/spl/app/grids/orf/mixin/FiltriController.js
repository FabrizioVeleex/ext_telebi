 ...
 */
Ext.define("spl.grids.orf.mixin.FiltroController", {
  ...
  initFiltri: function () {
    try {
      ...
      this.filtriPanel = {
        ...
        filtri: {
          data_doc: {
            fs: Ext.create("portal.v1.view.filtri.datarange.Fieldset", { myTag: "orf", myName: "data_doc", title: Locale.t('spl.grids.documenti.column.data_doc') }),
          },
        }
      }
