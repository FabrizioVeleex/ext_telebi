...
Ext.define("spl.grids.fat.mixin.FiltroController", {
  ...
  initFiltri: function () {
    try {
      ...
      this.filtriPanel = {
        ...
        filtri: {
          data_doc: {
            fs: Ext.create("portal.v1.view.filtri.datarange.Fieldset", { myTag: "fat", myName: "data_doc", title: Locale.t('spl.grids.documenti.column.data_doc') }),
          },
          combo_fat: {
            fs: Ext.create("spl.global.filtri.combo_fat.Fieldset")
          }
        }
      }
      ...
      this.filtriPanel.panel.add(
        ...
        this.filtriPanel.filtri.combo_fat.fs,
      )
  ...
  filtri_checkconfig: function () {
    ...
    try {
      ...
      if (Ext.global.Vars.confMod.grids.fat === undefined) {
        Ext.global.Vars.confMod.grids.fat = {}
      }
