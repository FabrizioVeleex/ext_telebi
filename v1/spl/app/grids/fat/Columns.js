 ...
 */
Ext.define("spl.grids.fat.Columns", {
  requires: [
  ...
  myColumns: [
      ...
      items: [
        {
          getClass: function (value, meta) {
            let css = "bd-action-null x-fas ",
              tdAttr;
            tdAttr = `data-qtip="${Locale.t("spl.grids.documenti.fat." + value.toLowerCase())}"`;
            ...
            switch (value) {
              case "F":
                ...
                break;
              case "N":
                css += "fa-euro-signk bd-color-red";
                break;
              case "S":
                css += "fa-gift bd-color-red";
                break;
              case "P":
                css += "fa-euro-sign bd-color-orange";
                break;
              default:
                tdAttr = ""
                break;
    ...
    {
      text: Locale.t("spl.grids.documenti.column.cd_age"),
      dataIndex: "cd_age",
      flex: 1,
      maxWidth: 60,
      minWidth: 60,
