 ...
 */
Ext.define("spl.grids.pak.Columns", {
  requires: [
  ...
  myColumns: [
      ...
      items: [
        {
          getClass: function (v, metadata, r) {
            if (r.data.imported === 1) {
              metadata.tdAttr = `data-qtip="${Locale.t("spl.grids.documenti.column.imported.yes")}"`;
              return "bd-action-null x-fas fa-list bd-color-blue";
            }
            metadata.tdAttr = `data-qtip="${Locale.t("spl.grids.documenti.column.imported.no")}"`;
    ...
    {
      text: Locale.t("spl.grids.documenti.column.num_ord_pak"),
      dataIndex: "num_doc",
      align: 'right',
      minWidth: 110,
      width: 110,
    ...
    {
      text: Locale.t("spl.grids.documenti.column.evasione"),
      dataIndex: "evasione",
      align: 'right',
      minWidth: 110,
      width: 110,
