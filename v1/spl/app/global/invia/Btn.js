Ext.define("spl.global.invia.Btn", {
  extend: "Ext.button.Button",
  xtype: "spl-global-btn-invia",
  require: [
    "spl.global.invia.Windows"
  ],
  azione: "I",
  desc: Locale.t("spl.grids.documenti.btn.esegui.invia"),
  text: Locale.t("spl.grids.documenti.btn.invia.text"),
  tooltip: Locale.t("spl.grids.documenti.btn.invia.tooltip"),
  ui: "orange",
  ...
  handler: function () {
    ...
    let win = Ext.create("spl.global.invia.Windows", {
