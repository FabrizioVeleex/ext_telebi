 ...
 */
Ext.define('spl.global.filtri.combo_ord.Fieldset', {
  ...
  //   type: 'vbox'
  // },
  title: Locale.t("spl.grids.documenti.ord.fieldset") + "/" + Locale.t("spl.grids.documenti.filtrocli"),
