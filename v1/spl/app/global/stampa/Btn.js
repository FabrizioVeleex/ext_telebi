Ext.define("spl.global.stampa.Btn", {
  extend: "Ext.button.Button",
  xtype: "spl-global-btn-stampa",
  require: [
    "spl.global.stampa.Windows"
  ],
  tooltip: Locale.t("spl.grids.documenti.btn.print.tooltip"),
  text: Locale.t("spl.grids.documenti.btn.print.text"),
  ui: "orange",
  ...
  handler: function () {
    ...
    if (recordsGood.length === 0) {
      Ext.Msg.show({
        ...
        msg: Locale.t("spl.grids.documenti.winprint.erroreselect"),
        buttons: Ext.Msg.OK,
    ...
    let win = Ext.create("spl.global.stampa.Windows", {
    ...
    function onClosePrintOk(records) {
      let fileNotFound = records["fileNotFound"],
        ...
        storeDocumentiGood = Ext.create(
          "spl.view.global.firma.store.GridDocumenti"
        ),
      ...
      if (fileNotFound.length > 0) {
        ...
        testoEccezione =
          ...
          "<hr>" +
          Locale.t("spl.grids.documenti.winfirma.firmalisteccezione");
        hidden = false;
        ui = "red";
        titleEccezione =
          " [" +
          Locale.t("global.attenzione") +
          " " +
          Locale.t("spl.grids.documenti.winfirma.firmatitleeccezione") +
          "]";
      }
      let wincomplete = Ext.create("Ext.window.Window", {
        ...
        modal: true,
        title:
          Locale.t("spl.grids.documenti.winfirma.firmacomplete") +
          titleEccezione,
        dockedItems: [
          {
            xtype: "toolbar",
            ...
            items: [
              {
                ...
                html:
                  "<h2>" +
                  Locale.t("spl.grids.documenti.winfirma.firmalist") +
                  "</h2>",
              },
              {
                xtype: "griddocumenti",
