 ...
 */
Ext.define("spl.forms.documento.component.mail.Mail", {
  ...
  requires: [
    ...
    'Ext.panel.Panel',
    'spl.forms.documento.component.mail.tagAttach.Combo',
    'spl.forms.documento.component.mail.tagEmail.Combo'
  ],
  scrollable: "y",
  bodyPadding: 15,
  buttons: [
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              xtype: "textfield",
              fieldLabel: Locale.t("spl.forms.documento.fields.mittente"),
              flex: 1,
        ...
        },
        {
          ...
          items: [
            {
              fieldLabel: Locale.t("spl.forms.documento.fields.attach.label"),
        ...
        },
        {
          ...
          items: [
            {
              xtype: "htmleditor",
              fieldLabel: Locale.t("spl.forms.documento.fields.corpo"),
              flex: 1,
              autoScroll: true,
