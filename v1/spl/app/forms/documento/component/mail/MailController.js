 ...
 */
Ext.define("spl.forms.documento.component.mail.MailController", {
  onSendNewEmail: function () {
    ...
    if (!mailto) {
      Ext.Msg.show({
        ...
        message: Locale.t("global.form.validation.form") + " " + Locale.t("spl.forms.documento.fields.mailto"),
        buttons: Ext.Msg.OK,
  ...
  onDragEnter: function () {
    const b = this.getView().down("#v1-spl-dragattach");
  ...
  onDrop: function (target, info) {
    let me = this,
      ...
      panelDrop = view.down("#v1-spl-dragattach"),
      tagAttach = view.down('v1-spl-tagattach-combo'),
      files, len, s;
