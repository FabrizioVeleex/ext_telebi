 ...
 */
Ext.define('itm.forms.gruppo.cards.Gruppo', {
    ...
    items: [
        {
            ...
            items: [
                {
                    xtype: 'textfield', fieldLabel: Locale.t('itm.forms.gruppo.fields.cd_gruppo'),
                    ...
                    bind: { readOnly: '{readOnly}', value: '{record.cd_gruppo}' }
                }
            ]
        },
        {
            ...
            items: [
                {
                    xtype: 'combobox', fieldLabel: Locale.t('itm.forms.gruppo.fields.cd_clm'), minChars: 3,
        ...
        },
        {
            ...
            items: [
                {
                    xtype: 'combobox', fieldLabel: Locale.t('itm.forms.gruppo.fields.cd_fam'), minChars: 3,
                    flex: 1, forceSelection: true,
                    allowBlank: false, blankText: Locale.t('global.form.blanktext'), autoLoadOnValue: true,
                    bind: {
                        store: '{storeFamiglie}',
        ...
        },
        {
            ...
            items: [
                {
                    xtype: 'textfield', fieldLabel: Locale.t('itm.forms.gruppo.fields.descr_gruppo'),
                    ...
                    bind: { readOnly: '{readOnly}', value: '{record.descr_gruppo}' }
                }
            ]
        }
    ]
