 ...
 */
Ext.define('itm.forms.articolo.cards.GridAttributi', {
  ...
  requires: [
    ...
    'itm.forms.articolo.component.comboAttributi.ComboAttributo',
  ...
  columns: [
    ...
    {
      text: Locale.t('itm.forms.articolo.gridattributi.column.attributo'), dataIndex: 'attributo', width: 500,
      getEditor: function (record) {
        ...
        return {
          ...
          emptyText: Locale.t('itm.forms.articolo.gridattributi.combotext'),
    ...
    {
      text: Locale.t('itm.forms.articolo.gridattributi.column.valore'), dataIndex: 'valore', width: 300,
      getEditor: function () {
        let vm = this.lookupViewModel()
