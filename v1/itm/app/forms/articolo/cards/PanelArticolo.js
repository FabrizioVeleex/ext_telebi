 ...
 */
Ext.define('itm.forms.articolo.cards.PanelArticolo', {
          ...
          items: [
            {
              ...
              items: [
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.cd_art'),
                  flex: 1, readOnly: true, minWidth: 150,
                  bind: { value: '{record.cd_art}' }
                },
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.cd_padre'),
                  flex: 1, readOnly: true, minWidth: 150,
                  bind: { value: '{record.cd_padre}' }
                },
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.cd_barcode'),
                  flex: 1, readOnly: true, minWidth: 150,
            ...
            },
            {
              ...
              items: [
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.descr_marca'),
                  flex: 1, readOnly: true, minWidth: 150,
                  bind: { value: '{record.descr_marca}' }
                },
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.cd_marca'),
                  flex: 1, readOnly: true, minWidth: 70,
                  bind: { value: '{record.cd_marca}' }
                },
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.descr_for'),
                  flex: 1, readOnly: true, minWidth: 150,
            ...
            },
            {
              ...
              items: [
                ...
                {
                  xtype: 'textfield', fieldLabel: Locale.t('itm.forms.articolo.fields.um'),
                  flex: 1, readOnly: true, minWidth: 80,
