 ...
 */
Ext.define('stcom.view.forms.vendite.grafici.GraficoFat', {
    ...
    requires: [
        ...
        'stcom.store.forms.vendite.grafici.ChartFat'
    ],
    scrollable: "y",
    title:Locale.t("stcom.forms.grafico.vendite.title"),
    layout: 'fit',
    items: [
        {xtype: 'cartesian',
            insetPadding: { top: 60, bottom: 20, left: 20, right: 40 },
            store:{ type:'v1-stcom-chartfat'},
            axes: [
                {
