 ...
 */
Ext.define('rec.model.forms.reso.Model', {
    ...
    fields: [
        ...
        { name: 'condizioni',type: 'string'},
        { name: 'manuale',type: 'int',defaultValue: 0},
    ...
    proxy: {
        type: 'rest',
        url: Backend.REST_API + 'forms/reso/',
        reader: {
            type: 'json',
            rootProperty: 'data'
        },
