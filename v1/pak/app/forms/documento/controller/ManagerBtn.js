Ext.define("pak.forms.documento.controller.ManagerBtn", {
  requires: [
    'Ext.toolbar.Fill'
  ],
  insertBtn: function (me, record) {
    ...
    if (me.checkRuoli(["99", "10"])) {
      ...
      me.toolBar.add({
        ui: 'red',
        text: Locale.t('pak.forms.documento.btn.scarta.text'),
        tooltip: Locale.t('pak.forms.documento.btn.scarta.tooltip'),
    ...
    me.toolBar.add({
      ui: 'blue',
      text: Locale.t('pak.forms.documento.btn.excel.text'),
      tooltip: Locale.t('pak.forms.documento.btn.excel.tooltip'),
