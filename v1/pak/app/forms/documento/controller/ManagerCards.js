Ext.define("pak.forms.documento.controller.ManagerCards", {
  requires: [
    'Ext.form.Panel',
    'pak.forms.documento.cards.Info',
    'pak.forms.documento.cards.NewMail',
    'pak.forms.documento.cards.Dashboard'
  ],
    ...
    me.listForms = [
      {
        ...
        card: Ext.create("pak.forms.documento.cards.Dashboard"),
        text: Locale.t("pak.forms.documento.cards.dashboard.title"),
        btn: {
          text: Locale.t("pak.forms.documento.cards.dashboard.title"),
      ...
      },
      {
        posizione: "info",
        backgroundColor: "LightBlue",
        card: Ext.create("pak.forms.documento.cards.Info"),
        text: Locale.t("pak.forms.documento.cards.infodoc.title"),
        btn: {
          text: Locale.t("pak.forms.documento.cards.infodoc.title"),
      ...
      },
      {
        ...
        text: Locale.t("pak.forms.documento.cards.anteprima.title"),
        btn: {
          text: Locale.t("pak.forms.documento.cards.anteprima.title"),
      ...
      },
      {
        ...
        text: Locale.t("pak.forms.documento.cards.anteprimafirma.title"),
        btn: {
          text: Locale.t("pak.forms.documento.cards.anteprimafirma.title"),
      ...
      },
      {
        posizione: "newmail",
        backgroundColor: "",
        card: Ext.create("pak.forms.documento.cards.NewMail", {
          posizione: "newmail",
        }),
        text: Locale.t("pak.forms.documento.cards.newmail.title"),
        btn: {
          text: Locale.t("pak.forms.documento.cards.newmail.title"),
