 ...
 */
Ext.define("pak.global.component.griddocumenti.GridDocumentiInvia", {
  ...
  columns: [
    ...
    {
      text: Locale.t("pak.grids.documenti.column.totemail"),
      dataIndex: "totemail",
      width: 90,
    ...
    {
      text: Locale.t("pak.grids.documenti.column.data_doc"),
      dataIndex: "data_doc",
      width: 120,
      xtype: "datecolumn",
      format: "d/m/Y",
    ...
    {
      text: Locale.t("pak.grids.documenti.column.cd_sogg_fat"),
