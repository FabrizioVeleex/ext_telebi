 ...
 */
Ext.define("pak.global.firma.Controller", {
  ...
  onAfterRender: function () {
    ...
    if (noSpool.length > 0) {
      vm.set("htmlNoSpool", `<span style="font-size:19px;">` + Locale.t("pak.grids.documenti.winfirma.docselected") + `: ${nRecordGood} </br><span style="color:red;"><hr>` + Locale.t("pak.grids.documenti.winfirma.warning") + `! ${noSpool.length} ` + Locale.t("pak.grids.documenti.winfirma.warningdesc") + `</span></span>`);
  ...
  onStampa: function () {
    if (this.signaturePad.isEmpty()) {
      Ext.Msg.show({
        ...
        msg: Locale.t("pak.grids.documenti.winfirma.firmavuota"),
        icon: Ext.MessageBox.INFO,
        buttonText: {
          no: Locale.t("pak.grids.documenti.winfirma.firmavuotabtn"),
        },
      });
    } else {
