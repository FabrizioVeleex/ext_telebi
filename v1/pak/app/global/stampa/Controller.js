 ...
 */
Ext.define("pak.global.stampa.Controller", {
  extend: "Ext.app.ViewController",
  alias: "controller.pak-v1-global-stampa",
  ...
  onAfterRender: function () {
    ...
    if (noSpool.length > 0) {
      vm.set("htmlNoSpool", `<span style="font-size:19px;">` + Locale.t("pak.grids.documenti.htmlnospool.docsselected") + ` : ${nRecordGood} </br><span style="color:red;"><hr>` + Locale.t("pak.grids.documenti.htmlnospool.warning") + `! ${noSpool.length} ` + Locale.t("pak.grids.documenti.htmlnospool.attesa") + `</span></span>`);
    }
  },
  onStampa: function () {
    let me = this,
