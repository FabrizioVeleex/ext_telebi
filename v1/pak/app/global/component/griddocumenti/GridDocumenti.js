 ...
 */
Ext.define("pak.global.component.griddocumenti.GridDocumenti", {
  ...
  columns: [
      ...
      items: [
        {
          getClass: function (view, metadata, record) {
            if (record.get('spool') === 0) {
              metadata.tdAttr = `data-qtip="${Locale.t('pak.grids.documenti.winfirma.nospool')}"`;
    ...
    {
      text: Locale.t("pak.grids.documenti.column.descr_trasp"),
