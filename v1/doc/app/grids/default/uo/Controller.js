 ...
 */
Ext.define('doc.view.grids.default.uo.Controller', {
    extend: 'portal.v1.view.grids.DefaultController',
    mixins: ['portal.v1.global.Util'],
    alias: 'controller.classi',
    requires: [
        'Ext.grid.column.Action',
        'doc.view.forms.default.uo.Model',
        'doc.view.forms.default.uo.Panel',
    ...
    onNew: function () {
        ...
        let NewRecord = Ext.create('doc.view.forms.default.uo.Model', {
    ...
    createForm: function (view, record, isnew) {
        ...
        this.getView().fireEvent('createTab', Ext.create('doc.view.forms.default.uo.Panel', {
