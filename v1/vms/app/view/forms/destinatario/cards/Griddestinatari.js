 ...
 */
Ext.define('vms.view.forms.destinatario.cards.Griddestinatari', {
    ...
    columns: [
        ...
        {text: Locale.t('vms.forms.destinatario.griddestinatari.risorsa'),
                ...
                return Ext.create('Ext.form.ComboBox', {
                    ...
                    listeners: {
                        select: function (combo,record) {
                            ...
                            if (lastrecord === row) {
                                grid.getStore().add(Ext.create('vms.model.forms.destinatario.Gridrisorse', {
