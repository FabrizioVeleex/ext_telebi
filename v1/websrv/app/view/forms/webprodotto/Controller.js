 ...
 */
Ext.define('websrv.view.forms.webprodotto.Controller', {
    extend: 'portal.v1.view.forms.mainCard.Controller',
    mixins: [
        'portal.v1.global.Util',
        'portal.v1.view.grids.DefaultController'
    ],
    alias: 'controller.v1-webprodotto',

    requires: [
        'websrv.model.forms.webprodotto.Webprodotto',
        'websrv.view.forms.webprodotto.cards.GridAccessi'
    ],
    /**
    ...
    init: function () {
        ...
        vm.set('record', Ext.create('websrv.model.forms.webprodotto.Webprodotto', {
    ...
    managerView: function () {
        ...
        try {
            ...
            vm.set('label', Locale.t('websrv.forms.webprodotto.title'))

            vm.set('toolbar.hideCard', false)

            this.cardAccessi = Ext.create('websrv.view.forms.webprodotto.cards.GridAccessi');
