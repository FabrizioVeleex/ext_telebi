 ...
 */
Ext.define('fmc.view.forms.destinatario.cards.Griddestinatari', {
    ...
    columns: [
        ...
        {text: Locale.t('fmc.forms.destinatario.griddestinatari.risorsa'),
                ...
                return Ext.create('Ext.form.ComboBox', {
                    ...
                    listeners: {
                        select: function (combo,record) {
                            ...
                            if (lastrecord === row) {
                                grid.getStore().add(Ext.create('fmc.model.forms.destinatario.Gridrisorse', {
