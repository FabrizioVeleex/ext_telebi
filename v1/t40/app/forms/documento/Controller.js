Ext.define("t40.forms.documento.controller.Controller", {
  ...
  requires: [
    "Ext.window.Toast",
    "t40.forms.documento.Model",
    "t40.forms.documento.controller.ManagerBtn",
    "t40.forms.documento.controller.ManagerCards",
    'Ext.drag.Target',
  ...
  init: function () {
    ...
    vm.set(
      "record",
      Ext.create("t40.forms.documento.Model", {
  ...
  managerView: function () {
    ...
    let me = this,
      ...
      managerBtn = Ext.create("t40.forms.documento.controller.ManagerBtn"),
      managerCards = Ext.create("t40.forms.documento.controller.ManagerCards");

    try {
      // Titolo tab
      vm.set("title", record.data["num_doc"] + " - " + record.data["rag_soc"] || "n.d.");
      vm.set("label", Locale.t("t40.forms.documento.title"));
  ...
  onScarta: function () {
    ...
    Ext.Msg.show({
      title: Locale.t('t40.form.documento.btn.scarta.text'),
      iconCls: 'x-fas fa-trash',
      message: Locale.t('t40.form.documento.btn.scarta.messaggio'),
  ...
  onSendNewEmail: function () {
    ...
    if (!mailto) {
      Ext.Msg.show({
        title: Locale.t("global.attenzione"),
        message: Locale.t("global.form.validation.form") + " " + Locale.t("t40.forms.documento.fields.mailto"),
        buttons: Ext.Msg.OK,
        icon: Ext.MessageBox.ERROR,
      });
      return false;
  ...
  onDragEnter: function () {
    const b = this.getView().down("#v1-t40-dragattach");
  ...
  onDrop: function (target, info) {
    let me = this,
      ...
      panelDrop = view.down("#v1-t40-dragattach"),
      tagAttach = view.down('v1-t40-tagattach-combo'),
      files, len, s;
  ...
  runDupOpen: function (record) {
    ...
    let newTab = {
      ...
      text: Locale.t("t40.forms.documento.infodoc"),
      btn: {
        xtype: "splitbutton",
