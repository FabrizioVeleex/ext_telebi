 ...
 */
Ext.define('t40.forms.documento.component.comboSoggetto.Combo', {
  ...
  name: 'idsoggetto',
  itemId: 'comboSogg',
  fieldLabel: Locale.t('t40.forms.documento.btn.associa.soggetto'),
  labelWidth: 80,
  emptyText: Locale.t('t40.forms.documento.btn.associa.emptytext'),
  displayField: 'ragsoc',
  valueField: 'id',
  hideTrigger: true,
  width: 500,
