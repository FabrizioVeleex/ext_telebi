 ...
 */
Ext.define('home.view.widgets.wvoi.MainController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.widgetvoi',
    requires: [
        'Ext.button.Button',
        ...
        'home.view.widgets.wvoi.GridAndamento',
        'home.view.widgets.wvoi.WinDettaglio',
        'home.view.widgets.wvoi.WindowUtenti'
    ],
    ...
    onOpenWinUtenti: function () {
        let me = this;
        this.wvoiwinutenti = Ext.create('home.view.widgets.wvoi.WindowUtenti', {
            scope: me,
            winWidget: this,
    ...
    loadChart: function () {
        ...
        myMask.show();
        if (!this.dataForm) {
            this.dataForm = Ext.create('home.model.widgets.wvoi.Chart');
        }
        this.dataForm.load({
    ...
    renderChart: function (record) {
        ...
        let aggiornamento =record.data.aggiornamento,
            chartRendimento = Ext.create('home.store.widgets.wvoi.GridStore', {
        ...
        if (!this.wvoiremdimento){
            this.wvoiremdimento = Ext.create('home.view.widgets.wvoi.GridAndamento', {
                flex: 1,
                height: 230,
    ...
    onOpenWindowDettaglio:function(grid, rowIndex){
        ...
        this.wvoiwindett = Ext.create('home.view.widgets.wvoi.WinDettaglio',{
            rec:rec,
        ...
        let wdwpanel = Ext.create('Ext.form.Panel', {
            border: false, items: [
                ...
                {xtype: 'container', flex: 1,
                    ...
                    defaults: {margin: 5},
                    items: [
                        {xtype:'datefield',fieldLabel: Locale.t('widgetvoice.esporta.dal'),labelWidth:60,
                            width: 200, format: 'd/m/Y',submitFormat:'Y-m-d',name:'dal'},
                        {xtype:'datefield',fieldLabel: Locale.t('widgetvoice.esporta.al'),labelWidth:60,
