 ...
 */
Ext.define('home.view.dashboard.widgets.word.view.ordinato.Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.v1-wordordinato',

    onAfterRender:function() {
        let me = this, vm = me.getViewModel()
        let grid = vm.getStore('storeOrdini')
    ...
    onChangeRaggruppamentoOrdinato: function (rdg, newval) {
        let me = this, vm = me.getViewModel()
        let grid = vm.getStore('storeOrdini')
            ...
            buttons: Ext.Msg.YESNO, icon: Ext.MessageBox.QUESTION, fn: function (b) {
                if (b === 'yes') {
                    Ext.Ajax.request({
                        ...
                        url: Backend.REST_VERSION + 'widgets/word/esportaordinato',
