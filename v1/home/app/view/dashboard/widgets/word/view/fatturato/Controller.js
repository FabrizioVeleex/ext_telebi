 ...
 */
Ext.define('home.view.dashboard.widgets.word.view.fatturato.Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.v1-wordfatturato',

    onAfterRender:function() {
        let me = this, vm = me.getViewModel()
        let grid = vm.getStore('storeFatturato')
