Ext.define('home.view.dashboard.notifiche.Grouping', {
    ...
    alias: 'feature.v1-groupingNotifiche',
    ...
    groupRowTpl: [
        ...
        '</tpl>', {
            ...
            beginRowSync: function (rowSync) {
                let groupingFeature = this.groupingFeature;
    ...
    createCache: function () {
        let metaGroupCache = this.metaGroupCache = {},
    ...
    invalidateCache: function() {
        let lockingPartner = this.lockingPartner;
    ...
    getMetaGroup: function (group) {
        let metaGroupCache = this.metaGroupCache || this.createCache(),
            key, metaGroup;
    ...
    onGroupClick: function(view, rowElement, groupName, e) {
        ...
        if (me.collapsible) {
            ...
            //FIXME FABRIZIO implementato apertura
            if (!bdOverBtnGroupAvvisi){
                if (groupIsCollapsed) {
                    me.expand(groupName);
                } else {
