 ...
 */
Ext.define('vda.view.forms.step.cards.Step', {
    ...
    items: [
        {xtype: 'container', flex: 1,
            ...
            items: [
                {xtype: 'numberfield', fieldLabel: Locale.t('vda.forms.step.fields.valore'),
        ...
        {xtype: 'container', flex: 1,
            ...
            defaults: {margin: 5,labelAlign:'top',msgTarget: 'side'},
            items: [
                {xtype: 'textfield', fieldLabel: Locale.t('vda.forms.step.fields.descit'),
        ...
        {xtype: 'container', flex: 1,
            ...
            defaults: {margin: 5,labelAlign:'top',msgTarget: 'side'},
            items: [
                {xtype: 'textfield', fieldLabel: Locale.t('vda.forms.step.fields.descen'),
                    flex:1, allowBlank: false, blankText: Locale.t('global.form.blanktext'),
                    maxLength: 50, maxLengthText: Locale.t('global.form.maxlengthtext'),
        ...
        {xtype: 'container', flex: 1,
            ...
            defaults: {margin: 5,labelAlign:'top',msgTarget: 'side'},
            items: [
                {xtype: 'textfield', fieldLabel: Locale.t('vda.forms.step.fields.desces'),
                    flex:1, allowBlank: false, blankText: Locale.t('global.form.blanktext'),
                    maxLength: 50, maxLengthText: Locale.t('global.form.maxlengthtext'),
        ...
        {xtype: 'container', flex: 1,
            ...
            defaults: {margin: 5,labelAlign:'top',msgTarget: 'side'},
            items: [
                {xtype: 'textfield', fieldLabel: Locale.t('vda.forms.step.fields.descfr'),
                    flex:1, allowBlank: false, blankText: Locale.t('global.form.blanktext'),
                    maxLength: 50, maxLengthText: Locale.t('global.form.maxlengthtext'),
